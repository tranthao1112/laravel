...
<head>
    ...
    <title>My Project</title><!--begin::Primary Meta Tags-->
    ...
    <link rel="stylesheet" href="{{asset('css/admin.css')}}"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
    <div class="app-wrapper"> <!--begin::Header-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="./index.html" class="brand-link"> <!--begin::Brand Image--> <img src="https://thethaovanhoa.mediacdn.vn/Upload/PQgc44ci4D5b7WtAo06jg/files/2021/11/anh2(31).jpeg" alt="AdminLTE Logo" class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text--> <span class="brand-text fw-light">JINHIT</span> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open"> <a href="{{route('ad')}}" class="nav-link active"> <i class="nav-icon bi bi-speedometer"></i>
                                <p>
                                    ADMIN
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{route('danhmuc')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Quản Lý Danh Mục</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="{{route('danhsach')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Quản Lý Sản Phẩm</p>
                                    </a> </li>
                            </ul>
                        </li>
                        <li class="nav-item"> <a href="{{route('user.index')}}" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                                <p>
                                    Quản Lý Tài Khoản
                                </p>
                            </a>
                        ...
                        <li class="nav-item"> <a href="{{route('order.index')}}" class="nav-link"> <i class="nav-icon bi bi-tree-fill"></i>
                                <p>
                                    Quản Lý Đơn hàng
                                </p>
                            </a>
