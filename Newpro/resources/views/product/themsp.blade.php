  ...
  <form action="{{route('save')}}" method="post" >
    <div class="sp" style="display:grid;grid-template-columns: 1fr 1fr;width:80%;margin:50px;margin-bottom:0">
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="pwd" name="tensp">
      </div>
      <div class="mb-3">
        <div class="item">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="pwd" name="hinhanh">
      </div>
      <div class="mb-3">
        <label for="pwd">Giá sản phẩm:</label>
        <input type="number" class="form-control" id="pwd" name="giasp">
      </div>
    </div>
    <div class="mb-3" style="margin-left:50px;">
      <label for="pwd">Mô tả:</label>
      <input type="text" class="form-control" id="pwd" name="mota" style="height:200px">
    </div>
